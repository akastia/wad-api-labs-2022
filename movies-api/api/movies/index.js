...
import { getNowPlayingMovies, getUpcomingMovies, getTopMovies } from '../tmdb-api';
...
//Get for now playing page
router.get('/tmdb/top_movies', asyncHandler( async(req, res) => {
